...
export default {
  ...
  methods: {
    ...
    async removeRightById(role, rightId) {
      ...
      // this.getRolesList();  //会导致重新渲染列表，导致打开的展开栏合上
    ...
    getLeafKeys(node, arr) {
      if (!node.children) {
        //如果当前节点中不包含children属性，则证明是三级节点
        return arr.push(node.id); //直接把该节点的id放到数组中即可
      }
